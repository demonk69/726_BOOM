...
add_files -cflags "-std=c++11 -I$root/include" "$root/src/fetch_packet.cpp"
add_files -cflags "-std=c++11 -I$root/include" "$root/src/fetch_buffer.cpp"
add_files -cflags "-std=c++11 -I$root/include" "$root/src/predecode.cpp"
add_files -cflags "-std=c++11 -I$root/include" "$root/src/predictor.cpp"
add_files -cflags "-std=c++11 -I$root/include" "$root/src/rvc.cpp"
...
add_files -cflags "-std=c++11 -I$root/include" "$root/src/mul.cpp"
add_files -cflags "-std=c++11 -I$root/include" "$root/src/divider.cpp"
