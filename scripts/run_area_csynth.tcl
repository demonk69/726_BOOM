...
set ::env(BOOM_HLS_PROJECT) boom_hls_${gate}_area
set ::env(BOOM_HLS_SOLUTION) solution_area
...
source [file join [file dirname [info script]] .. directives area_directives.tcl]
csynth_design
close_project
exit
