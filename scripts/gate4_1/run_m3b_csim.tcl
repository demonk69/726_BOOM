...
open_project -reset m3b_full_core_csim
set_top boom_core_top
add_files -cflags "-std=c++11 -I$root/include" "$root/src/boom_core_merged.cpp"
add_files -tb -cflags "-std=c++11 -I$root/include" "$root/tb/differential/divider_full_core_tests.cpp"
open_solution -reset solution_m3b_csim
