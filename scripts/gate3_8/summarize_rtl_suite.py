...
def main():
    parser = argparse.ArgumentParser(description="Create the Gate 3.8 RTL verification matrix")
    ...
    print(f"GATE3_8_MATRIX tests={len(rows)} pass={passed} fail={len(rows) - passed}")
    return 0
