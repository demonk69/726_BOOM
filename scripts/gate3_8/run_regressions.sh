...
BUILD_DIR="$ROOT/build/gate3_8/final_regression"
REPORT_DIR="$ROOT/reports/gate3_8/regression_after_artifacts"
LOG_DIR="$REPORT_DIR/logs"
TRACE_DIR="$REPORT_DIR/hls_traces"
BASELINE_TRACES="$ROOT/reports/gate3_8/baseline_artifacts/accepted_hls_traces"
CXX_BIN=${CXX:-g++}
...
printf '%s\n' 'Gate 3.8 post-fix accepted-source regressions complete.'
