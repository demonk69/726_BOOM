...
PROJECT="$ROOT/boom_hls_gate3_8_baseline"
SOLUTION="$PROJECT/solution_baseline"
REPORT_DIR="$ROOT/reports/gate3_8/fixed_synthesis"
RTL_DIR="$ROOT/reports/gate3_8/fixed_artifacts/conservative_rtl"
...
BOOM_HLS_GATE=gate3_8 FPGA_PART=${FPGA_PART:-xczu7ev-ffvc1156-2-e} CLOCK_PERIOD=${CLOCK_PERIOD:-10} \
...
printf '%s\n' "GATE3_8_CONSERVATIVE_CSYNTH_PASS report=$REPORT_DIR/boom_core_top_csynth.rpt"
