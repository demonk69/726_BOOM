...
PROJECT="$ROOT/boom_hls_gate4_w1_baseline"
SOLUTION="$PROJECT/solution_baseline"
REPORT_DIR="$ROOT/reports/gate4_0/w1/csynth"
RTL_DIR="$REPORT_DIR/rtl"
...
BOOM_HLS_GATE=gate4_w1 FPGA_PART=${FPGA_PART:-xczu7ev-ffvc1156-2-e} CLOCK_PERIOD=${CLOCK_PERIOD:-10} \
...
printf '%s\n' "GATE4_W1_CSYNTH_PASS report=$REPORT_DIR/boom_core_top_csynth.rpt"
