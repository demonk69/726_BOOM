...
set project [file normalize "$root/build/gate5_3_fetch_buffer/b3i/fetch_packet_frontend_hls"]
file mkdir [file dirname $project]
cd [file dirname $project]
open_project -reset [file tail $project]
set_top synth_fetch_packet_frontend_top
...
open_solution -reset solution_b3i_packet_frontend
