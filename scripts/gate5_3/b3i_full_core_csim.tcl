...
set build [file normalize "$root/build/gate5_3_fetch_buffer/b3i/csim"]
file mkdir $build
cd $build
open_project -reset b3i_full_core_csim
...
add_files -tb -cflags $cflags $root/tb/differential/gate5_3_b3i_full_core.cpp
open_solution -reset solution_b3i_csim
