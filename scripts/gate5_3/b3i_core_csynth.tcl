...
if {![info exists ::env(GATE5_3_B3I_HLS_PROJECT)]} {
    error "GATE5_3_B3I_HLS_PROJECT is required"
}
set project [file normalize $::env(GATE5_3_B3I_HLS_PROJECT)]
...
open_solution -reset solution_b3i
