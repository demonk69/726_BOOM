...
| Gate 5.4 PF5 Commit BIM Training | VERIFIED_FOR_SUPPORTED_SUBSET | Commit-only canonical BIM updates pass 6205/6205 directed checks, exhaustive, integrated random/long-run, focused RTL, twelve standalone native/CSim/full-core RTL programs, two fault cases, 9/9 canonical tops, and the complete required current-source preservation matrix. |
